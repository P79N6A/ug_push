      ...
      <el-row type="flex" justify="center">
        <el-col :xs="24" :sm="23" :md="23" :lg="23" :xl="23">
          ...
          <el-checkbox-group v-model="checkedMid" @change="handleCheckedMidChange" v-if="datalist && datalist.length > 0">
            <item-list :key="idx" :callback="onSearch" :item="item" :index="(formInline.page - 1) * formInline.count + idx + 1" v-for="(item, idx) in datalist"></item-list>
          </el-checkbox-group>
...
export default {
  ...
  methods: {
    ...
    onSearch() {
      ...
      const tempData = {
        url: "http://10.85.115.126:6065/query_mid",
        param: {
