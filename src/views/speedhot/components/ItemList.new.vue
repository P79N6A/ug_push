      ...
      <el-row>
        <div class="item-status-box clearfix">
          ...
          <div class="clearfix right">
            ...
            <el-button v-if="Number(item.materials_type) != 1" type="success" plain size="mini" class="right" @click="passEvent">通过</el-button>
