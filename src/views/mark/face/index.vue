    ...
    <el-row class="search-form-wrap">
      <el-col :span="24">
        <el-form inline :model="formInline" size="small">
          ...
          <el-form-item label="人手分离">
            <el-select v-model="hand_state" placeholder="请选择" clearable>
              <el-option label="否" :value="0"></el-option>
              <el-option label="是" :value="1"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="标注更改">
            <el-select v-model="change_state" placeholder="请选择" clearable>
              <el-option label="否" :value="0"></el-option>
              <el-option label="是" :value="1"></el-option>
            </el-select>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onSearch() {
      ...
      const tempData = {
        url: "http://10.85.125.60:13141/query.json", // 接口请求地址
        param: {
          ...this.formInline,
          time: uploadTime,
          username: this.searchName, // 用户邮箱前缀
          change_state: this.change_state === "" ? -1 : this.change_state,
          hand_state: this.hand_state === "" ? -1 : this.hand_state,
        }
      };
      const params = {
