    ...
    <el-main v-if="pageAuth === 1" style="padding: 20px 0;">
      <el-row type="flex" justify="center">
        <el-col :xs="24" :sm="23" :md="23" :lg="23" :xl="23">
          <el-form inline :model="formInline" label-position="right" label-width="70px" class="search-form">
            ...
            <el-form-item label="物料状态">
              <el-radio-group v-model="formInline.flag_check">
                ...
                <el-radio style="padding: 10px 0" :label="0">待审</el-radio>
                <el-radio style="padding: 10px 0" :label="1">已通过</el-radio>
          ...
          <!-- 审核列表 -->
          <el-checkbox-group v-model="checkedMid" @change="handleCheckedMidChange" v-if="datalist && datalist.length > 0" style="padding-top: 30px;margin-top: 30px;">
  ...
  methods: {
    ...
    getMaterialSource() {
      const tempData = {
        ...
        url: `${api_ip}:5000/query_source_list`,
        param: {}
      };
      const params = {
    ...
    onSearch() {
      ...
      const tempData = {
        ...
        param: {
          ...
          start_stamp: this.formInline.date[0] || "", //开始时间
          end_stamp: this.formInline.date[1] || "", //结束时间
