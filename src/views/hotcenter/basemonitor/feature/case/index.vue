<template>
  <el-main v-if="pageAuth === 1">
    <el-row class="pane-title-wrap clearfix">
      <h6 class="pane-title left">特征变化轨迹跟踪</h6>
      <a class="link-btn left" :href="`/hot/#/hotcenter/basemonitor/feature/case/detail?mid=${formInline.mid}`" target="_blank">查看细分点击率</a>
    </el-row>
