<template>
  <div v-if="data">
    ...
    <el-button style="margin-left: 5px;" type="danger" icon="el-icon-delete" plain size="mini" title="下线" @click="delDialogVisible = true;deleteCause = '2';">
...
export default {
  ...
  data() {
    return {
      apiConf: {
        ...
        whiteAuditPass:"/field/whiteAuditPass" //白名单通过审核
      },
      dialogVisible: false,
  ...
  methods: {
    ...
    deleteAction() {
      const data = {
        ...
        params: {
          ...
          uid: this.data.uid,
          audit_type: 1, //审核人员审核下线，普通用户不可再操作
          username: this.email,
          cip: 230
        }
      };
    ...
    passAction() {
        const data = {
        url: this.apiConf.whiteAuditPass,
        params: {
          field_id: this.data.field_id,
          uid: this.data.uid,
          audit_type: 1, //审核人员审核白名单用户通过，普通用户不可再操作
          username: this.email,
          cip: 230
        }
      };
